...
class grid_utm:
    ...
    def inomenFromExtent(self, xmin,ymin,xmax,ymax):
        ...
        def get_bin_y(lat, spacing): 
            return int(np.floor((88-lat)/ spacing )) #from top 88 downward. I forgot that it must be a multiple of 4.
        ...
        def get_inomen_part(center_lat, center_lon, calc_scale_id ):
            ...
            return calc_scale_text[y % len(calc_scale_text)][x % len(calc_scale_text[0])]
...
if __name__ == "__main__":
    ...
    print(test.getInomenFromRasterio('/home/mauricio/Desktop/Doutorado_psq/PFC_2024/geometadata_creator/SCN_Carta_Topografica_Matricial-0017−2−NE-NB-22-Y-D-V-2-NE-25.000.tif'))
    print(test.getInomenFromRasterio('/home/mauricio/Desktop/Doutorado_psq/PFC_2024/geometadata_creator/SCN_Carta_Topografica_Matricial-PORTOALEGRE-NO-SH-22-Y-B-III-2-NO-25.000.tif'))
    print(test.getInomenFromRasterio('/home/mauricio/Desktop/Doutorado_psq/PFC_2024/geometadata_creator/SCN_Carta_Topografica_Matricial-PORTOALEGRE-SE-SH-22-Y-B-III-2-SE-25.000.tif'))
